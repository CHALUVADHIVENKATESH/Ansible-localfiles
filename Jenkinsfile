pipeline {
    ...
    stages {
      stage('CheckOut GitHub Repo') {
          steps {
              checkout([$class: 'GitSCM', branches: [[name: 'master']], doGenerateSubmoduleConfigurations: false, extensions: [], submoduleCfg: [], userRemoteConfigs: [[credentialsId: 'GitHubAccess', url: 'git@github.com:SreeVeerDevOps/DevOpsB20-git-terraform-packer-jenkins.git']]])
            }
        }
        ...
        stage('Ansible check') {
            ...
            steps {
                    ...
                    sh 'ansible-playbook -i hosts.cfg nginx-playbook-remote.yml --check'
